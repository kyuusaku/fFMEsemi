...
parser.add_argument('--save_path', type=str, default='output/mnist_feature_matching_unsupervised_entropy')
...
for epoch in range(300):
    ...
    # report
    print("Iteration %d, time = %ds, loss_entropy = %.4f, loss_unl = %.4f, loss_gen = %.4f" % (epoch, time.time()-begin, loss_entropy, loss_unl, loss_gen))
    sys.stdout.flush()
