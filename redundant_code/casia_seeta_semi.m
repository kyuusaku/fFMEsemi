function casia_seeta_semi(o,d)
% casiasub vggface feature semi
...
%% para
save_path = ['result/casia_seeta_' d '/semi'];
...
if ~exist(pca_data, 'file')
    % load original data
    load(fullfile(data_path, strcat(para.dataset, '_', d, '.mat')));
    % check gnd
